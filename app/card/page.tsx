...
function XiaohongshuIcon() {
  return (
    <svg
      ...
      viewBox="0 0 24 24"
    >
      <title>Xiaohongshu SVG Icon</title>
      <path
        fill="currentColor"
...
function XIcon() {
  return (
    <svg
      className={styles.cardSocialSvg}
      xmlns="http://www.w3.org/2000/svg"
      width="18"
      height="18"
      viewBox="0 0 24 24"
    >
      <title>New Twitter SVG Icon</title>
      <path
        fill="none"
        stroke="currentColor"
        strokeLinecap="round"
...
const cardButtons = [
  { icon: <BrushIcon />, label: "Commission", href: "/commissions" },
  {
    icon: <PersonIcon />,
    label: "OC Page",
    href: "https://akirac.vercel.app/characters",
  },
  {
    icon: <InstagramIcon />,
    label: "akirachizu_ (main)",
    href: "https://www.instagram.com/akirachizu_",
  },
  {
    icon: <InstagramIcon />,
    label: "akira.png (sub)",
    href: "https://www.instagram.com/akirac.png",
  },
  {
    icon: <XiaohongshuIcon />,
    label: "Xiaohongshu",
    href: "https://xhslink.com/m/19zjqFalUv",
  },
];

const socialIcons = [
  { label: "X", icon: <XIcon />, href: "https://x.com/Akira_Chizu" },
  {
    label: "YouTube",
    icon: <YouTubeIcon />,
    href: "https://www.youtube.com/channel/UCBp_iwJjfaUKO4tyi_6ACIg",
  },
  {
    label: "TikTok",
    icon: <TikTokIcon />,
    href: "https://www.tiktok.com/@akirachizu",
  },
  {
    label: "Discord",
    icon: <DiscordIcon />,
